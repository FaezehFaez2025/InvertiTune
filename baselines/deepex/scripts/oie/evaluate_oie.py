...
if __name__=="__main__":
    ...
    parser.add_argument('-k', dest='k_value', type=int, default=None, help='K value for top-K extraction (overrides task-specific defaults)')
    ...
    # Use provided K value if specified, otherwise use task-specific defaults
